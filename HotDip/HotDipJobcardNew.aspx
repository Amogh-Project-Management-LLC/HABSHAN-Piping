<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="HotDipJobcardNew.aspx.cs" Inherits="HotDip_HotDipJobcardNew" Title="Hot Dip" %>
    ...
    <div>
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadButton ID="btnAutoNum" runat="server" Text="Auto Number" Width="110" OnClick="btnAutoNum_Click" CausesValidation="false"></telerik:RadButton>
                </td>
                <td>

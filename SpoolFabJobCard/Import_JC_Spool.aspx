<%@ Page Title="JC Spool Import" Language="C#" MasterPageFile="~/PopupMasterPage.master" AutoEventWireup="true" CodeFile="Import_JC_Spool.aspx.cs" Inherits="SpoolFabJobCard_Import_JC_Spool" %>
            ...
            <ContentTemplate>
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Import_Format/BULK_JOBCARD_SHOP_IMPORT.xlsx">Sample File to Upload</asp:HyperLink>
                        </td>
                    </tr>
                    <tr style="padding-top: 10px">
                        ...
                        <td>
                         ...
                         <td>
                            ...
                            <telerik:RadButton ID="btnProceed" runat="server" Visible="false" Text="Proceed" Width="90" OnClick="btnProceed_Click"></telerik:RadButton>

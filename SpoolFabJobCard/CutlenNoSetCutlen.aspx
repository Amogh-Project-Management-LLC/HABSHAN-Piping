<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CutlenNoSetCutlen.aspx.cs" Inherits="CutlenNoSetCutlen" Title="Not in Cutting-Plan" %>
    ...
    <div>
        <asp:GridView ID="jcGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" SkinID="GridViewSkin"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SET_CUTLEN" HeaderText="In Cutlen" SortExpression="SET_CUTLEN" />
            </Columns>
        </asp:GridView>
    </div>
    <asp:SqlDataSource ID="itemsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT ISO_TITLE1, SPOOL, PT_NO, MAT_CODE1, SIZE_DESC, WALL_THK, PIPE_EP1, PIPE_EP2, NET_QTY, SET_CUTLEN FROM VIEW_CUTLEN_NO_SET_CUTLEN WHERE (ISSUE_ID = :ISSUE_ID) ORDER BY ISO_TITLE1, SPOOL, PT_NO">
        <SelectParameters>

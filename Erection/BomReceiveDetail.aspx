<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BomReceiveDetail.aspx.cs" Inherits="PipeSupport_BomReceiveDetail" Title="Material Receive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="itemsGridView" runat="server" AutoGenerateColumns="False" CssClass="DataWebControlStyle"
                            DataKeyNames="RECV_ID,BOM_ID" DataSourceID="itemstDataSource" Width="100%" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MAT_CODE1" HeaderText="Ident Code" SortExpression="MAT_CODE1"
                                    ReadOnly="true" />
    ...
    <asp:ObjectDataSource ID="itemstDataSource" runat="server" DeleteMethod="DeleteQuery"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsErectionBTableAdapters.VIEW_BOM_RECV_DETAILTableAdapter"
        ...
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="%" Name="RECV_ID" QueryStringField="RECV_ID"
                Type="Decimal" />
        </SelectParameters>
        <DeleteParameters>
            <asp:Parameter Name="Original_RECV_ID" Type="Decimal" />

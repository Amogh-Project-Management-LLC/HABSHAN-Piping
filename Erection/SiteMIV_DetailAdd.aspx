<%@ Page Title="" Language="C#" MasterPageFile="~/PopupMasterPage.master" AutoEventWireup="true" CodeFile="SiteMIV_DetailAdd.aspx.cs" Inherits="Erection_SiteMIV_DetailAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="matDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT DISTINCT MAT_ID, MAT_CODE1 FROM VIEW_SITE_MIV_ISSUE_SUMMARY WHERE (JC_ID = :WO_ID) ORDER BY MAT_CODE1">
        <SelectParameters>
            <asp:ControlParameter ControlID="hiddenWOID" DefaultValue="-1" Name="WO_ID" PropertyName="Value" />
        </SelectParameters>
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="JCMIVQtyDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT MAT_ID, MAT_CODE1,DEL_BOM_QTY,JC_REQ_QTY AS REQ_QTY
FROM VIEW_SITE_MIV_ISSUE_SUMMARY
WHERE (JC_ID = :WO_ID)">
        <SelectParameters>
            <asp:ControlParameter ControlID="hiddenWOID" DefaultValue="-1" Name="WO_ID" PropertyName="Value" />
        </SelectParameters>
    ...
    <asp:HiddenField ID="hiddenWOID" runat="server" />
</asp:Content>

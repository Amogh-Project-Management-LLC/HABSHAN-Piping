...
public partial class PipeSupport_BomReceiveNew : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("BomReceive.aspx?Filter=" + Request.QueryString["Filter"]);
    }

    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        VIEW_BOM_RECVTableAdapter wo = new VIEW_BOM_RECVTableAdapter();
        try
        {
            wo.InsertQuery(
                ...
                decimal.Parse(cboFromSubcon.SelectedValue.ToString()),
    ...
    private void set_jc_no()
    {
        try
        {
            ...
            string prefix = "MAT-DO-";
            string new_jc = WebTools.NextSerialNo("PIP_BOM_RECEIVE", "RECV_NO", prefix, 4,

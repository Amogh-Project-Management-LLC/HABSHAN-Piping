...
public partial class PipeSupport_BomRequest : System.Web.UI.Page
{
    ...
    {
        if (if_selected() == true) Response.Redirect("BomRequestDetail.aspx?REQ_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    {
        Response.Redirect("BomRequestNew.aspx");
    }
    ...
    protected void btnPreview_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ReportViewer.aspx?ReportID=16&REQ_ID=" + rowsGridView.SelectedValue.ToString());
    }
}
<%@ Page Title="Site MIV Joints" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MatIssueLooseJoints.aspx.cs" Inherits="Erection_MatIssueLooseJoints" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <telerik:RadGrid ID="itemsGridView" runat="server" CellSpacing="-1" DataSourceID="itemsDataSource" GridLines="None" AllowPaging="true"
            ...
            <MasterTableView AutoGenerateColumns="False" DataSourceID="itemsDataSource" DataKeyNames="JC_ID, JOINT_ID" AllowAutomaticDeletes="true"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="SHEET" AllowFiltering="false" FilterControlAltText="Filter SHEET column" HeaderText="SHEET" SortExpression="SHEET" UniqueName="SHEET">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="JOINT_SIZE_DEC" AllowFiltering="false" DataType="System.Decimal" FilterControlAltText="Filter JOINT_SIZE_DEC column" HeaderText="JOINT SIZE" SortExpression="JOINT_SIZE_DEC" UniqueName="JOINT_SIZE_DEC">
                    </telerik:GridBoundColumn>
    ...
    <asp:ObjectDataSource ID="itemsDataSource" runat="server" DeleteMethod="DeleteQuery" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsErectionTableAdapters.VIEW_MAT_ISSUE_LOOSE_JOINTTableAdapter">
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="sqlJointSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>" ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT JOINT_ID, JOINT_TITLE 
FROM VIEW_JOINT_TITLE
WHERE ISO_TITLE1 = :ISO_TITLE1 AND SPOOL LIKE '%EREC%'
ORDER BY JOINT_TITLE">
        <SelectParameters>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BomReceive.aspx.cs" Inherits="PipeSupport_BomReceive" Title="Material Receive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="rowsGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="RECV_NO" HeaderText="Request No" SortExpression="RECV_NO" />
                                ...
                                <asp:BoundField DataField="FROM_SUB_CON_NAME" HeaderText="From Subcon" SortExpression="FROM_SUB_CON_NAME"
                                    ReadOnly="true" />
                                <asp:BoundField DataField="TO_SUB_CON_NAME" HeaderText="To Subcon" SortExpression="TO_SUB_CON_NAME"
                                    ReadOnly="true" />
    ...
    <asp:ObjectDataSource ID="rowsDataSource" runat="server" DeleteMethod="DeleteQuery"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsErectionBTableAdapters.VIEW_BOM_RECVTableAdapter"

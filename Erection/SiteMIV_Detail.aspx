<%@ Page Title="Site MIV Materials" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SiteMIV_Detail.aspx.cs" Inherits="Erection_SiteMIV_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ObjectDataSource ID="itemsDataSource" runat="server" SelectMethod="GetDataRev"
        TypeName="dsErectionBTableAdapters.VIEW_JC_MIV_MATSTableAdapter" UpdateMethod="UpdateQuery"
        ...
        <SelectParameters>
            ...
            <asp:QueryStringParameter DefaultValue="-1" Name="ISSUE_REV_ID" QueryStringField="rev_id" Type="Decimal" />
        </SelectParameters>
        <DeleteParameters>
            <asp:Parameter Name="Original_ISSUE_ITEM_ID" Type="Decimal" />
        </DeleteParameters>

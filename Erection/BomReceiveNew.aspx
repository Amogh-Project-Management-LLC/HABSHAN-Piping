<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BomReceiveNew.aspx.cs" Inherits="PipeSupport_BomReceiveNew" Title="Material Receive" %>
                    ...
                    <ContentTemplate>
                        <table class="TableStyle" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboFromSubcon" runat="server" AppendDataBoundItems="True" DataSourceID="SubconDataSource"
                                        DataTextField="SUB_CON_NAME" DataValueField="SUB_CON_ID" Width="135px">
                                        <asp:ListItem Selected="True" Value="-1">(From Subcon)</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:CompareValidator ID="FromSubconValidator" runat="server" ControlToValidate="cboFromSubcon"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboToSubcon" runat="server" AppendDataBoundItems="True" DataSourceID="SubconDataSource"
                                        DataTextField="SUB_CON_NAME" DataValueField="SUB_CON_ID" Width="135px">
                                        <asp:ListItem Selected="True" Value="-1">(To Subcon)</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:CompareValidator ID="ToSubconValidator" runat="server" ControlToValidate="cboToSubcon"
                                        ErrorMessage="*" Operator="NotEqual" ValueToCompare="-1"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>

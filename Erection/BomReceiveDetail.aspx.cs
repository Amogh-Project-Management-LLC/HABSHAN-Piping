...
public partial class PipeSupport_BomReceiveDetail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.HeadingMessage = "Material Receive <br/>" +
            WebTools.GetExpr("RECV_NO", "PIP_BOM_RECEIVE", "RECV_ID=" + Request.QueryString["RECV_ID"]);
        }
    }

    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        VIEW_BOM_RECV_DETAILTableAdapter items = new VIEW_BOM_RECV_DETAILTableAdapter();
        try
        {

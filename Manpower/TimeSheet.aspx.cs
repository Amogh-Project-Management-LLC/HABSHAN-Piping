...
public partial class Manpower_TimeSheet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Master.HeadingMessage = "Timesheet";

            Master.RadGridList = RadGrid1.ClientID;

            //Master.AddModalPopup("~/Manpower/ManpowerNew.aspx", ImageButtonAdd.ClientID, 300, 500);

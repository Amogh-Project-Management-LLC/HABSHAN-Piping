<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Supp_SWN_Detail.aspx.cs" Inherits="PipeSupport_Supp_SWN_Detail" Title="Support SWN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="itemsGridView" runat="server" AutoGenerateColumns="False" CssClass="DataWebControlStyle"
                            DataKeyNames="SWN_ID,BOM_ID" DataSourceID="itemstDataSource" Width="100%" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MAT_CODE1" HeaderText="Support Tag" SortExpression="MAT_CODE1" ReadOnly="true" />
    ...
    <asp:ObjectDataSource ID="itemstDataSource" runat="server" DeleteMethod="DeleteQuery"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsSupp_DTableAdapters.VIEW_SUPP_SWN_DETAILTableAdapter" UpdateMethod="UpdateQuery">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="-1" Name="SWN_ID" QueryStringField="SWN_ID"
                Type="Decimal" />
        </SelectParameters>
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="bomDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT BOM_ID, BOM_ITEM_B FROM VIEW_BOM_EREC_ITEM WHERE (SG_GROUP = 'SUPPORT') AND (PROJ_ID = :PROJECT_ID) AND (ISO_TITLE1 = :ISO_TITLE1) AND (BOM_ID NOT IN (SELECT BOM_ID FROM VIEW_SUPP_UNDER_SWN WHERE (UNDER_SWN = 'Y'))) ORDER BY BOM_ITEM_B">
        <SelectParameters>

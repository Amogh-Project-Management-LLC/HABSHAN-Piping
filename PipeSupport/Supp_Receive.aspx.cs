...
public partial class PipeSupport_Supp_Receive : System.Web.UI.Page
{
    ...
    {
        if (if_selected() == true) Response.Redirect("Supp_Receive_Detail.aspx?RECV_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    {
        Response.Redirect("Supp_Receive_New.aspx");
    }
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Supp_ReportViewer.aspx?ReportID=8&RECV_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    protected void btnBulkList_Click(object sender, EventArgs e)
    {
        if (if_selected() == true) Response.Redirect("Supp_Receive_Bulk.aspx?RECV_ID=" + rowsGridView.SelectedValue.ToString());

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Supp_Release_New.aspx.cs" Inherits="PipeSupport_Supp_Release_New" Title="Support Release" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <table class="TableStyle" style="width: 100%">
                            <tr>
                                <td style="width: 140px; background-color: #ccccff;">Release No
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboSubcon" runat="server" AppendDataBoundItems="True" DataSourceID="SubconDataSource"
                                        DataTextField="SUB_CON_NAME" DataValueField="SUB_CON_ID" OnSelectedIndexChanged="cboSubcon_SelectedIndexChanged"
                                        Width="200px">

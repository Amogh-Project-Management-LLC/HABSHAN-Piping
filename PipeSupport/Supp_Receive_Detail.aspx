<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Supp_Receive_Detail.aspx.cs" Inherits="PipeSupport_Supp_Receive_Detail"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <td>
                        <asp:GridView ID="itemsGridView" runat="server" AutoGenerateColumns="False" CssClass="DataWebControlStyle"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ACTUAL_WT" HeaderText="Weight" SortExpression="ACTUAL_WT"
                                    ReadOnly="true" />
    ...
    <asp:ObjectDataSource ID="itemstDataSource" runat="server" DeleteMethod="DeleteQuery"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsSupp_ETableAdapters.VIEW_SUPP_RECEIVE_DTTableAdapter"

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Supp_Receive_New.aspx.cs" Inherits="PipeSupport_Supp_Receive_New" Title="Support Receive" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <table class="TableStyle" style="width: 100%">
                            <tr>
                                <td style="width: 140px; background-color: whitesmoke;">Receive Number
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 140px; background-color: whitesmoke;">Receive Date
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 140px; background-color: whitesmoke;">Area Name</td>
                                <td>
                                    <asp:TextBox ID="txtArea" runat="server" Width="100px"></asp:TextBox>
                                    <cc1:CalendarExtender ID="txtArea_CalendarExtender" runat="server"
                                        Format="dd-MMM-yyyy" OnClientShowing="DisplayDateToday" PopupButtonID="btnDate"
                                        PopupPosition="BottomRight" TargetControlID="txtArea">
                                    </cc1:CalendarExtender>
                                </td>
                            </tr>
                            <tr>

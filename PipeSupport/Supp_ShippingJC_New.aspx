<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Supp_ShippingJC_New.aspx.cs" Inherits="Supp_ShippingJC_New" Title="Support Shipping JC" %>
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table>
                    <tr>
                        <td style="width: 140px; background-color: WhiteSmoke;">Shipping JC No
                        </td>
                        <td>

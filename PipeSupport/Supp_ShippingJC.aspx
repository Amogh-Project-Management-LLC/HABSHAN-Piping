<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Supp_ShippingJC.aspx.cs" Inherits="Supp_ShippingJC" Title="Support Shipping JC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="rowsGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    DataSourceID="rowsDataSource" Width="100%" DataKeyNames="SHIP_ID" SkinID="GridViewSkin"
                    PageSize="18" OnRowEditing="rowsGridView_RowEditing">
                    <ClientSettings Selecting-AllowRowSelect="true"></ClientSettings>
                    <MasterTableView AllowAutomaticUpdates="true" DataKeyNames="SHIP_ID">
                    <Columns>
                        <telerik:GridEditCommandColumn ButtonType="ImageButton">
                            <ItemStyle Width="20px" />
                        </telerik:GridEditCommandColumn>                        
                        <telerik:GridBoundColumn DataField="SHIP_JC_NO" HeaderText="Shipping JC No" SortExpression="SHIP_JC_NO" />
    ...
    <asp:ObjectDataSource ID="rowsDataSource" runat="server" DeleteMethod="DeleteQuery"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsSupp_GTableAdapters.VIEW_SUPP_SHIP_JCTableAdapter"
        UpdateMethod="UpdateQuery">
        <DeleteParameters>
            <asp:Parameter Name="Original_SHIP_ID" Type="Decimal" />
        </DeleteParameters>
        <UpdateParameters>
            <asp:Parameter Name="SHIP_JC_NO" Type="String" />
        ...
        <SelectParameters>
            <asp:SessionParameter DefaultValue="-1" Name="PROJECT_ID" SessionField="PROJECT_ID"
                Type="Decimal" />
            <asp:ControlParameter ControlID="txtSearch" DefaultValue="%" Name="SHIP_JC_NO" PropertyName="Text"
                Type="String" />
        </SelectParameters>

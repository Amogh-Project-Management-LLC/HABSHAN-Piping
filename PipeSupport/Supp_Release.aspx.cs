...
public partial class PipeSupport_Supp_Release : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Master.HeadingMessage = "Support Release";
        }
    }
    protected void btnView_Click(object sender, EventArgs e)
    {
        if (if_selected() == true) Response.Redirect("Supp_Release_Detail.aspx?REL_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    {
        Response.Redirect("Supp_Release_New.aspx");
    }
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Supp_ReportViewer.aspx?ReportID=12&Arg1=" + rowsGridView.SelectedValue.ToString());
    }

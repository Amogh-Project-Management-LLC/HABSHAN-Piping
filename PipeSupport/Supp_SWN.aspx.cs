...
public partial class PipeSupport_Supp_SWN : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Master.HeadingMessage = "Support SWN";
        }
    }
    protected void btnView_Click(object sender, EventArgs e)
    {
        if (if_selected() == true) Response.Redirect("Supp_SWN_Detail.aspx?SWN_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    {
        Response.Redirect("Supp_SWN_New.aspx");
    }
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Supp_ReportViewer.aspx?ReportID=11&Arg1=" + rowsGridView.SelectedValue.ToString());
    }

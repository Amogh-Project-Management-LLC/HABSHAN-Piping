...
public partial class PipeSupport_Supp_PackingList : System.Web.UI.Page
{
    ...
    {
        if (if_selected() == true) Response.Redirect("Supp_PackingList_Detail.aspx?PACKING_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    {
        Response.Redirect("Supp_PackingList_New.aspx");
    }
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Supp_ReportViewer.aspx?ReportID=7&PACKING_ID=" + rowsGridView.SelectedValue.ToString());
    }

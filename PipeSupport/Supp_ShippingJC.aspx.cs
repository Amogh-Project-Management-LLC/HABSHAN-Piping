...
public partial class Supp_ShippingJC : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Master.HeadingMessage = "Shipping Jobcard";
        }
    }
    protected void btnView_Click(object sender, EventArgs e)
    {
        if (if_selected() == true) Response.Redirect("Supp_ShippingJC_Detail.aspx?SHIP_ID=" + rowsGridView.SelectedValue.ToString());
    }
    ...
    {
        Response.Redirect("Supp_ShippingJC_New.aspx");
    }
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Supp_ReportViewer.aspx?ReportID=14&SHIP_ID=" + rowsGridView.SelectedValue.ToString());
    }

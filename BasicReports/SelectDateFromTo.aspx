<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SelectDateFromTo.aspx.cs" Inherits="BasicReports_SelectDateFromTo"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="background-color: whitesmoke;">
        <telerik:RadButton ID="btnArea" runat="server" Text="Small Bore Shop InchDia Status" Width="220" OnClick="btnArea_Click"></telerik:RadButton>
    </div>
</asp:Content>
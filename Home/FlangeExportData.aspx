<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="FlangeExportData.aspx.cs" Inherits="Home_FlangeExportData" Title="Export Data" EnableSessionState="ReadOnly" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <script type="text/javascript">
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: left">
                            <telerik:RadListBox ID="ExportCatList" runat="server" Height="450px" Width="150px"
                        ...
                        <td style="text-align: left">
                            <telerik:RadListBox ID="ExportsListBox1" runat="server" Height="450px" Width="600px" AutoPostBack="true"
    ...
    <asp:SqlDataSource ID="exportsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ...
        SelectCommand="SELECT EXPT_ID, EXPT_TITLE FROM VIEW_IPMS_SYS_EXPORT WHERE (EXPT_TITLE LIKE FNC_FILTER(:EXPT_TITLE))  AND CAT_ID = :CAT_ID AND SUB_CAT_ID = :SUB_CAT_ID 
        AND MODULE_ID=2"
    ...
    <asp:SqlDataSource ID="sqlExportCat" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT * FROM IPMS_SYS_EXPORT_CAT WHERE CAT_ID=7 ORDER BY CAT_NAME"></asp:SqlDataSource>

    <asp:SqlDataSource ID="sqlExportSubCat" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>"
        SelectCommand="SELECT * FROM IPMS_SYS_EXPORT_SUB_CAT WHERE  SUB_CAT_ID IN (SELECT SUB_CAT_ID FROM IPMS_SYS_EXPORT WHERE CAT_ID= :CAT_ID) ORDER BY SUB_CAT_NAME">
        <SelectParameters>
            <asp:ControlParameter ControlID="ExportCatList" DefaultValue="-1" Name="CAT_ID" PropertyName="SelectedValue" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>"
        SelectCommand="SELECT EXPT_ID, EXPT_TITLE FROM VIEW_IPMS_SYS_EXPORT WHERE MODULE_ID=2 "
        OnSelecting="exportsDataSource_Selecting"></asp:SqlDataSource>

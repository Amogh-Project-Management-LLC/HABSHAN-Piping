<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Theme="Blue"
    CodeFile="GalvJobcardItems.aspx.cs" Inherits="SpoolMove_GalvJobcardItems" Title="Galvanising Jobcard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="cboNewSpool" runat="server" DataSourceID="SpoolDataSource"
                        DataTextField="SPL_TITLE" DataValueField="SPL_ID" Visible="False" Width="237px">
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <asp:ObjectDataSource ID="itemsDataSource" runat="server" DeleteMethod="DeleteQuery"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsGalvJobcardTableAdapters.VIEW_GALV_JC_SPLTableAdapter"
    ...
    <asp:SqlDataSource ID="SpoolDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ipmsConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ipmsConnectionString.ProviderName %>" SelectCommand="SELECT SPL_ID, SPL_TITLE  FROM VIEW_SPL_INDEX
WHERE (PROJ_ID = :PROJ_ID)
AND (ISO_TITLE1 = :ISO) AND SPOOL LIKE FNC_FILTER('SPL-')
ORDER BY SPL_TITLE
">
        <SelectParameters>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ConsumableReturn.aspx.cs" Inherits="Consumable_ConsumableReturn" Title="Consumable Return" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="RadGrid1_DataSource"
                ...
                <MasterTableView AllowAutomaticDeletes="true" AllowAutomaticUpdates="true" DataKeyNames="LOG_ID" DataSourceID="RadGrid1_DataSource" HierarchyLoadMode="Client" PageSize="20"
                    ...
                    <Columns>
                        ...
                        <telerik:GridDateTimeColumn DataField="RETURN_DATE" DataType="System.DateTime" FilterControlAltText="Filter RETURN_DATE column"
                            HeaderText="Return Date" SortExpression="RETURN_DATE" UniqueName="RETURN_DATE"
                        ...
                        <telerik:GridBoundColumn DataField="MAT_CODE" FilterControlAltText="Filter MAT_CODE column" HeaderText="Mat Code/ Symbol" SortExpression="MAT_CODE" UniqueName="MAT_CODE" ReadOnly="true">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="RETURN_QTY" DataType="System.Decimal" FilterControlAltText="Filter RETURN_QTY column" HeaderText="Returned Qty"
                            SortExpression="RETURN_QTY" UniqueName="RETURN_QTY">
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings>
    ...
    <asp:ObjectDataSource ID="RadGrid1_DataSource" runat="server" SelectMethod="GetData"
        TypeName="dsConsumableTableAdapters.VIEW_CONSUMABLE_RETURNTableAdapter" UpdateMethod="UpdateQuery"
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="RETURN_QTY" Type="Decimal" />

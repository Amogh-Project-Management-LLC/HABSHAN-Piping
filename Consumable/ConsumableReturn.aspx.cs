...
public partial class Consumable_ConsumableReturn : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Master.HeadingMessage = "Cosumable Return";

            Master.RadGridList = RadGrid1.ClientID;

            Master.AddModalPopup("~/Consumable/ConsumableReturnNew.aspx", ImageButtonAdd.ClientID, 450, 600);
        }
    }

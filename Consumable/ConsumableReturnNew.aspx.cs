...
public partial class Consumable_ConsumableReturnNew : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Master.HeadingMessage("Consumable Return * New");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        VIEW_CONSUMABLE_RETURNTableAdapter consumable = new VIEW_CONSUMABLE_RETURNTableAdapter();
        try
        {

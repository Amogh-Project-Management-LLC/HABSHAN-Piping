<%@ Page Language="C#" MasterPageFile="~/PopupMasterPage.master" AutoEventWireup="true"
    CodeFile="ConsumableReturnNew.aspx.cs" Inherits="Consumable_ConsumableReturnNew" Title="Consumable Return * New" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="width: 150px; background-color: Gainsboro;">Return Date</td>
                    <td>

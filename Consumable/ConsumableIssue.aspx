<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ConsumableIssue.aspx.cs" Inherits="Consumable_ConsumableIssue" Title="Consumable Issue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="RadGrid1_DataSource"
                ...
                <MasterTableView AllowAutomaticDeletes="true" AllowAutomaticUpdates="true" DataKeyNames="LOG_ID" DataSourceID="RadGrid1_DataSource" HierarchyLoadMode="Client" PageSize="20"
                    ...
                    <Columns>
                        ...
                        <telerik:GridDateTimeColumn DataField="ISSUE_DATE" DataType="System.DateTime" FilterControlAltText="Filter ISSUE_DATE column"
                            HeaderText="Issue Date" SortExpression="ISSUE_DATE" UniqueName="ISSUE_DATE"
                        ...
                        <telerik:GridBoundColumn DataField="ISSUED_QTY" DataType="System.Decimal" FilterControlAltText="Filter ISSUED_QTY column" HeaderText="Issued Qty"
                            SortExpression="ISSUED_QTY" UniqueName="ISSUED_QTY">
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings>
    ...
    <asp:ObjectDataSource ID="RadGrid1_DataSource" runat="server" SelectMethod="GetData"
        TypeName="dsConsumableTableAdapters.VIEW_CONSUMABLE_ISSUETableAdapter" UpdateMethod="UpdateQuery"

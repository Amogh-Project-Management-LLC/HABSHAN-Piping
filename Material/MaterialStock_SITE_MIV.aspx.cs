...
public partial class Material_MaterialStock_SITE_MIV : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.HeadingMessage = "SITE MIV : ";
    ...
    {
        db_export.ExportDataSetToExcel(MatSiteMIVDataSource, "MAT_SITE_MIV.xls");
    }
}
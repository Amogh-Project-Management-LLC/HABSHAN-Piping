...
public partial class Material_MaterialReserveBOM : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.AddModalPopup("~/Material/MaterialReserveBOMAdd.aspx?REQ_ID=" + Request.QueryString["REQ_ID"], btnAdd.ClientID, 450, 650);

...
public partial class Material_MaterialStock_Requistion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.HeadingMessage = "Mat Requisition : ";
    ...
    {
        db_export.ExportDataSetToExcel(MatRequisitonDS, "Mat_Requisition.xls");
    }
}
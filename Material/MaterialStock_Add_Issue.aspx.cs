...
public partial class Material_MaterialStock_Add_Issue : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.HeadingMessage = "Additional Issue : ";
    ...
    {
        db_export.ExportDataSetToExcel(MatAddDataSource, "mat_additional.xls");
    }
}